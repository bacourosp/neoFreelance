...
<div id="bidPeriodDiv"  style="position:relative" >
        ...
        <label>Jours</label> (maximum 99 jours) &nbsp;<span id="dureereal-err" class="err-msg">Entrez une duré�e de r�éalisation s'il vous plait.</span>
</div>
<div id="bidPeriodDiv"  style="position:relative" >
        ...
        <label>Euros</label> (0 pour un projet FREE, et > 5000 �) &nbsp;<span id="montantreal-err" class="err-msg">Montant de la ré�alisation s'il vous plait.</span>
</div>
<div id="divProjectDescription" >
	<table width="400" border="0">
		<tr>
			<td width="600"><label for="projectDetails"><b>Dé�crire votre Offre en dé�tail :</b></label>
		...
		<tr>
			...
			<span id="project-description-hint" class="hint">Plus vous dé�taillez votre offre, plus vous aurez de chance d'ê�tre choisi pour ce projet.<span class="hint-pointer">&nbsp;</span></span>
			</div>
			</td>
		</tr>
		<tr>
