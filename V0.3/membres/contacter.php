...
=======
<div id="contact" class="reveal-modal offre">
<p>Attention ! Ceci est une mise en relation et votre email sera communiqué au membre !</p>
<a class="close-reveal-modal"><img src="../images/icones/icon_close1.png"></a>
<?
  $select2 = "SELECT PSEUDO FROM MEMBRES WHERE ID='".$_SESSION["ID_UTILISATEUR"]."';";
  $result2 = mysql_query($select2,$link) or die ('Erreur : '.mysql_error() );
...
<div id="divProjectDescription" >
	<table width="400" border="0">
		<tr>
			...
			<span id="project-description-err" class="err-msg">Entrez un minimum de dix caractères s'il vous plait</span></td>
		...
		<tr>
			...
			<span id="project-description-hint" class="hint">Plus vous détaillez votre message, plus vous aurez de chance d'être contactéet.<span class="hint-pointer">&nbsp;</span></span>
			</div>
			</td>
		</tr>
		<tr>
...
>>>>>>> df32d60ae62e63506d694cdd80a9bfe5d7685294
</div>