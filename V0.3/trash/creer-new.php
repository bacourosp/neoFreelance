...
$message = "Veuillez renseigner tout les champs, merci <br>";
		...
		$PROPRIETAIREPROJET =$_SESSION['ID_UTILISATEUR'];
...
//Ceci d�coule de mon souhait d'avoir des client Anonymes
...
// Envoi du mail d'activation
                   ...
                   if(!@mail($_POST["email"], $sujet, $message, 'From: noreply@neofreelance.com'."\r\n"))
                     ...
                     $message = "Votre projet a correctement �t� cr�er<br />\n";
...
<div id="divProjectName" style="position: relative ">
	...
	<span id="project-name-err" class="err-msg">Entrez un nom � votre projet (minimum 10 caract�res)</span>
	...
	<span id="project-name-hint" class="hint" style="display:none;">Le nom de votre projet est important car c'est ce qui va attirer les freelances � soumissionner. Vous devez clairement d�crire vos besoins en aussi peu de mots que possible.<span class="hint-pointer">&nbsp;</span></span>
...
<span><b>Comp�tences requises : <a style="color:#008BCB; text-decoration:underline; cursor:pointer" onClick="showBoxSkills();">Explorer <img src="../images/icones/loupe.png" width="20"></a></b></span>
...
<span id="skill-input-hint" class="hint">Selon ce que demande votre projet, les freelances du r�seau sauront postuler � votre projet.<span class="hint-pointer">&nbsp;</span></span>

</div>

</br>

<!------Affichage dune comp�tence------>

<div id="box-skills"><b>Comp�tences : </b><a style="position:absolute; top:0; right:0;" onClick="hideBoxSkills();"><img src="../images/icones/icon_close1.png"></a>



<? include('competences-new.php'); ?>
...
<div id="divProjectDescription" >
	...
	<table width="767" border="0">
		...
		<tr>
			...
			<td width="600"><label for="projectDetails"><b>D�crire votre projet en d�tail :</b></label>
		...
		<tr>
			...
			<span id="project-description-hint" class="hint">Plus vous d�taillez votre projet, plus vous aurez de chance d'avoir exactement ce que vous cherchez apr�s un minimum de temps.<span class="hint-pointer">&nbsp;</span></span>
...
<div id="bidPeriodDiv"  style="position:relative" >
        ...
        <span id="bidperiod-hint" class="hint">Donnez vous 1-99 jours pour recevoir des soumissions et choisir un freelance si vous s�l�ctionnez 1 votre projet sera marqu� URGENT!<span class="hint-pointer">&nbsp;</span></span>

        <label>Jours</label> (maximum 99 jours, 0 pour une p�riode ind�finie) &nbsp;<span id="bidperiod-err" class="err-msg">Entrez une p�riode de soumission s'il vous plait.</span>
...
<button class="ns_btn ns_blue" type="submit" value="post" onClick="ajouterSkills();">Cr�er</button>
