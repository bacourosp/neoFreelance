...
<div id="bidPeriodDiv"  style="position:relative" >
        ...
        <label>Jours</label> (maximum 99 jours) &nbsp;<span id="dureereal-err" class="err-msg">Entrez une durée de réalisation s'il vous plait.</span>
</div>
<div id="bidPeriodDiv"  style="position:relative" >
        <label for="subCategory"><b>Devis éstimé à :</b></label><br>
        ...
        <label>Jours</label> (0 pour un projet FREE, et > 5000 €) &nbsp;<span id="montantreal-err" class="err-msg">Montant de la réalisation s'il vous plait.</span>
</div>
<div id="divProjectDescription" >
	<table width="400" border="0">
		...
		<tr>
			...
			<span id="project-description-hint" class="hint">Plus vous détaillez votre offre, plus vous aurez de chance d'être choisis pour ce projet.<span class="hint-pointer">&nbsp;</span></span>
			</div>
			</td>
		</tr>
		<tr>
