          ...
          else
          {
               ...
               else
               {
                   ...
                   foreach($caracteres_aleatoires as $i)
                    ...
                    $requete = "INSERT INTO MEMBRES (ID, PSEUDO, EMAIL, MDP, DEPUIS, CLEF_ACTIVATION) VALUES('', '".$PSEUDO."', '".$EMAIL."','".$MDP."','".time()."','".$clef_activation."');" ;
                    mysql_query($requete);
...
<div class="half_column" style="position:relative; height:90px">
	...
	<input type="text" class="gaf_textbox" name="newusername" id="tbx_username" value="<? echo $_POST["newusername"] ?>" onMouseOver="showHint('tbx_username_hint');" onMouseOut="hideHint('tbx_username_hint');" onBlur="showError10('tbx_username','tbx_username_err')">&nbsp;
...
<div class="half_column" style="height:90px">
	...
	<input type="password" class="gaf_textbox" name="newuserpasswd" id="passwd1" value="<? echo $_POST["newuserpasswd"] ?>">&nbsp;<br>
...
<div class="half_column" style="height:90px">
	...
	<input type="password" class="gaf_textbox" name="newuserpasswd1" id="passwd2" value="<? echo $_POST["newuserpasswd1"] ?>" onChange="verifPasswd();"><br>
