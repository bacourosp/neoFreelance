...
<div class="half_column" style="height:90px">
	<label for="passwd1"><b>Confirmer mot de Passe :</b></label>&nbsp;<span id="pwd-err-rhs" style="display:none;color:red;"></span><br>
	<input type="password" class="gaf_textbox" name="newuserpasswd2" id="passwd2" value="" onKeyUp="verifPasswd(this.form);"><br>
...
<div style="padding-left:5px;">
	En cliquant sur rejoindre, vous indiquez que vous avez lu et accepté les 
